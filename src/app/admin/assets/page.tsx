...
export default function AdminAssetsPage() {
  ...
  const inventory: AssetRecord[] = [
    ...
    {
      id: "ast-img-128",
      name: "Founder CH. Arshad Profile Asset",
      category: "LEADERSHIP",
    ...
    {
      id: "ast-img-229",
      name: "Co-Founder B. Sanjay Profile Asset",
      category: "LEADERSHIP",
    ...
    {
      id: "ast-img-4e5",
      name: "CEO G. Bhanu Prasad Profile Asset",
      category: "LEADERSHIP",
    ...
    },
    {
      ...
      path: "/assets/image-assests/ed14ea822462d93c926056fcfd9db4c5 (1).jpg",
      type: "JPG Image",
      usedIn: "Round 8: Review & Commitment (Legacy)",
      dimensions: "Landscape",
    },
    // Canonical 4 Learning Modules Cards
    {
      id: "ast-card-mod-1",
      name: "Module 01: Foundations & Vibe Coding",
      category: "CODING",
      path: "/assets/cards/modules/module-01-foundations-vibe-coding.png",
      type: "JPG Image",
      usedIn: "Curriculum Page, Landing Page Module Cards",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-mod-2",
      name: "Module 02: Full-Stack Web Engineering",
      category: "CODING",
      path: "/assets/cards/modules/module-02-fullstack-web-engineering.png",
      type: "JPG Image",
      usedIn: "Curriculum Page, Landing Page Module Cards",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-mod-3",
      name: "Module 03: Databases & Security Architecture",
      category: "CODING",
      path: "/assets/cards/modules/module-03-database-security.png",
      type: "JPG Image",
      usedIn: "Curriculum Page, Landing Page Module Cards",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-mod-4",
      name: "Module 04: Production Deployment & Ship",
      category: "CODING",
      path: "/assets/cards/modules/module-04-production-deployment.png",
      type: "JPG Image",
      usedIn: "Curriculum Page, Landing Page Module Cards",
      dimensions: "Landscape (16:9)",
    },
    // Canonical 8 Application Rounds Cards
    {
      id: "ast-card-rnd-1",
      name: "Round 01: Personal Information Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-01-personal-information.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-2",
      name: "Round 02: Education & Academics Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-02-education-academics.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-3",
      name: "Round 03: Developer Projects Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-03-developer-projects.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-4",
      name: "Round 04: Availability & Hardware Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-04-availability-hardware.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-5",
      name: "Round 05: Technical Awareness Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-05-technical-awareness.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-6",
      name: "Round 06: Mindset & Work Habits Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-06-mindset-work-habits.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-7",
      name: "Round 07: Thought-Process Interview Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-07-thought-process-interview.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
    {
      id: "ast-card-rnd-8",
      name: "Round 08: Review & Commitment Card",
      category: "APPLICATION",
      path: "/assets/cards/rounds/round-08-review-commitment.png",
      type: "JPG Image",
      usedIn: "Landing Page Rounds, Apply Overview",
      dimensions: "Landscape (16:9)",
    },
